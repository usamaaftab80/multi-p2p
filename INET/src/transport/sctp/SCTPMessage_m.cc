...
SCTPSimpleMessage::SCTPSimpleMessage(const SCTPSimpleMessage& other) : cPacket()
{
...
void SCTPSimpleMessage::setDataLen(uint32 dataLen_var)
{
    this->dataLen_var = dataLen_var;
}
...
void SCTPSimpleMessage::setData(unsigned int k, char data_var)
{
    if (k>=data_arraysize) throw cRuntimeError("Array of size %d indexed by %d", data_arraysize, k);
...
void SCTPSimpleMessage::setCreationTime(simtime_t creationTime_var)
{
...
void SCTPSimpleMessage::setEncaps(bool encaps_var)
{
    this->encaps_var = encaps_var;
}
...
const char *SCTPSimpleMessageDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return "dataLen";
        case 1: return "data";
        case 2: return "creationTime";
        case 3: return "encaps";
        default: return NULL;
    }
}
...
bool SCTPSimpleMessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPSimpleMessage *pp = (SCTPSimpleMessage *)object; (void)pp;
    switch (field) {
        case 0: ulong2string(pp->getDataLen(),resultbuf,bufsize); return true;
        case 1: long2string(pp->getData(i),resultbuf,bufsize); return true;
        case 2: double2string(pp->getCreationTime(),resultbuf,bufsize); return true;
        case 3: bool2string(pp->getEncaps(),resultbuf,bufsize); return true;
...
SCTPMessage_Base::SCTPMessage_Base(const SCTPMessage_Base& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPMessage_Base::setSrcPort(uint16 srcPort_var)
{
...
void SCTPMessage_Base::setDestPort(uint16 destPort_var)
{
...
void SCTPMessage_Base::setTag(uint32 tag_var)
{
    this->tag_var = tag_var;
}
...
void SCTPMessage_Base::setChecksumOk(bool checksumOk_var)
{
    this->checksumOk_var = checksumOk_var;
}
...
bool SCTPMessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPMessage_Base *pp = (SCTPMessage_Base *)object; (void)pp;
    switch (field) {
        case 0: ulong2string(pp->getSrcPort(),resultbuf,bufsize); return true;
        case 1: ulong2string(pp->getDestPort(),resultbuf,bufsize); return true;
        case 2: ulong2string(pp->getTag(),resultbuf,bufsize); return true;
        case 3: bool2string(pp->getChecksumOk(),resultbuf,bufsize); return true;
        case 4: {std::stringstream out; out << pp->getChunks(i); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        default: return false;
    }
}
...
const char *SCTPMessageDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 4: return "cPacketPtr"; break;
        default: return NULL;
    }
}
...
SCTPChunk::SCTPChunk(const SCTPChunk& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPChunk::setChunkType(uint8 chunkType_var)
{
    this->chunkType_var = chunkType_var;
}
...
bool SCTPChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPChunk *pp = (SCTPChunk *)object; (void)pp;
    switch (field) {
        case 0: ulong2string(pp->getChunkType(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPInitChunk::SCTPInitChunk(const SCTPInitChunk& other) : SCTPChunk()
{
    setName(other.getName());
    addresses_arraysize = 0;
    this->addresses_var = 0;
...
void SCTPInitChunk::setInitTag(uint32 initTag_var)
{
    this->initTag_var = initTag_var;
}
...
void SCTPInitChunk::setA_rwnd(uint32 a_rwnd_var)
{
    this->a_rwnd_var = a_rwnd_var;
}
...
void SCTPInitChunk::setNoOutStreams(uint16 noOutStreams_var)
{
    this->noOutStreams_var = noOutStreams_var;
}
...
void SCTPInitChunk::setNoInStreams(uint16 noInStreams_var)
{
    this->noInStreams_var = noInStreams_var;
}
...
void SCTPInitChunk::setInitTSN(uint32 initTSN_var)
{
    this->initTSN_var = initTSN_var;
}
...
void SCTPInitChunk::setForwardTsn(bool forwardTsn_var)
{
    this->forwardTsn_var = forwardTsn_var;
}
...
void SCTPInitChunk::setAddresses(unsigned int k, const IPvXAddress& addresses_var)
{
    if (k>=addresses_arraysize) throw cRuntimeError("Array of size %d indexed by %d", addresses_arraysize, k);
...
void SCTPInitChunk::setUnrecognizedParameters(unsigned int k, uint8 unrecognizedParameters_var)
{
    if (k>=unrecognizedParameters_arraysize) throw cRuntimeError("Array of size %d indexed by %d", unrecognizedParameters_arraysize, k);
    this->unrecognizedParameters_var[k]=unrecognizedParameters_var;
}
...
const char *SCTPInitChunkDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return "initTag";
        case 1: return "a_rwnd";
        case 2: return "noOutStreams";
        case 3: return "noInStreams";
        case 4: return "initTSN";
        case 5: return "forwardTsn";
        case 6: return "addresses";
        case 7: return "unrecognizedParameters";
        default: return NULL;
    }
}
...
bool SCTPInitChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPInitChunk *pp = (SCTPInitChunk *)object; (void)pp;
    switch (field) {
        case 0: ulong2string(pp->getInitTag(),resultbuf,bufsize); return true;
        case 1: ulong2string(pp->getA_rwnd(),resultbuf,bufsize); return true;
        case 2: ulong2string(pp->getNoOutStreams(),resultbuf,bufsize); return true;
        case 3: ulong2string(pp->getNoInStreams(),resultbuf,bufsize); return true;
        case 4: ulong2string(pp->getInitTSN(),resultbuf,bufsize); return true;
        case 5: bool2string(pp->getForwardTsn(),resultbuf,bufsize); return true;
        case 6: {std::stringstream out; out << pp->getAddresses(i); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 7: ulong2string(pp->getUnrecognizedParameters(i),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPInitAckChunk::SCTPInitAckChunk(const SCTPInitAckChunk& other) : SCTPChunk()
{
    setName(other.getName());
    addresses_arraysize = 0;
    this->addresses_var = 0;
...
void SCTPInitAckChunk::setInitTag(uint32 initTag_var)
{
    this->initTag_var = initTag_var;
}
...
void SCTPInitAckChunk::setA_rwnd(uint32 a_rwnd_var)
{
    this->a_rwnd_var = a_rwnd_var;
}
...
void SCTPInitAckChunk::setNoOutStreams(uint16 noOutStreams_var)
{
    this->noOutStreams_var = noOutStreams_var;
}
...
void SCTPInitAckChunk::setNoInStreams(uint16 noInStreams_var)
{
    this->noInStreams_var = noInStreams_var;
}
...
void SCTPInitAckChunk::setInitTSN(uint32 initTSN_var)
{
    this->initTSN_var = initTSN_var;
}
...
void SCTPInitAckChunk::setForwardTsn(bool forwardTsn_var)
{
    this->forwardTsn_var = forwardTsn_var;
}
...
void SCTPInitAckChunk::setAddresses(unsigned int k, const IPvXAddress& addresses_var)
{
    if (k>=addresses_arraysize) throw cRuntimeError("Array of size %d indexed by %d", addresses_arraysize, k);
    this->addresses_var[k]=addresses_var;
}
...
void SCTPInitAckChunk::setCookie(unsigned int k, char cookie_var)
{
    if (k>=cookie_arraysize) throw cRuntimeError("Array of size %d indexed by %d", cookie_arraysize, k);
    this->cookie_var[k]=cookie_var;
}
...
void SCTPInitAckChunk::setUnrecognizedParameters(unsigned int k, uint8 unrecognizedParameters_var)
{
    if (k>=unrecognizedParameters_arraysize) throw cRuntimeError("Array of size %d indexed by %d", unrecognizedParameters_arraysize, k);
    this->unrecognizedParameters_var[k]=unrecognizedParameters_var;
}
...
void SCTPInitAckChunk::setStateCookie(const cPacketPtr& stateCookie_var)
{
    this->stateCookie_var = stateCookie_var;
}
...
const char *SCTPInitAckChunkDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        ...
        case 8: return "unrecognizedParameters";
        case 9: return "stateCookie";
        default: return NULL;
    }
}
...
bool SCTPInitAckChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 5: bool2string(pp->getForwardTsn(),resultbuf,bufsize); return true;
        case 6: {std::stringstream out; out << pp->getAddresses(i); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 7: long2string(pp->getCookie(i),resultbuf,bufsize); return true;
        case 8: ulong2string(pp->getUnrecognizedParameters(i),resultbuf,bufsize); return true;
        case 9: {std::stringstream out; out << pp->getStateCookie(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        default: return false;
    }
}
...
const char *SCTPInitAckChunkDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 6: return "IPvXAddress"; break;
        case 9: return "cPacketPtr"; break;
        default: return NULL;
    }
}
...
SCTPCookieEchoChunk::SCTPCookieEchoChunk(const SCTPCookieEchoChunk& other) : SCTPChunk()
{
    setName(other.getName());
    cookie_arraysize = 0;
    this->cookie_var = 0;
...
void SCTPCookieEchoChunk::setCookie(unsigned int k, char cookie_var)
{
    if (k>=cookie_arraysize) throw cRuntimeError("Array of size %d indexed by %d", cookie_arraysize, k);
    this->cookie_var[k]=cookie_var;
}
...
void SCTPCookieEchoChunk::setStateCookie(const cPacketPtr& stateCookie_var)
{
    this->stateCookie_var = stateCookie_var;
}
...
void SCTPCookieEchoChunk::setUnrecognizedParameters(unsigned int k, uint8 unrecognizedParameters_var)
{
    if (k>=unrecognizedParameters_arraysize) throw cRuntimeError("Array of size %d indexed by %d", unrecognizedParameters_arraysize, k);
    this->unrecognizedParameters_var[k]=unrecognizedParameters_var;
}
...
const char *SCTPCookieEchoChunkDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        ...
        case 1: return "stateCookie";
        case 2: return "unrecognizedParameters";
        default: return NULL;
    }
}
...
bool SCTPCookieEchoChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPCookieEchoChunk *pp = (SCTPCookieEchoChunk *)object; (void)pp;
    switch (field) {
        case 0: long2string(pp->getCookie(i),resultbuf,bufsize); return true;
        case 1: {std::stringstream out; out << pp->getStateCookie(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 2: ulong2string(pp->getUnrecognizedParameters(i),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPCookie::SCTPCookie(const SCTPCookie& other) : cPacket()
{
    setName(other.getName());
    localTieTag_arraysize = 0;
    this->localTieTag_var = 0;
...
void SCTPCookie::setCreationTime(simtime_t creationTime_var)
{
    this->creationTime_var = creationTime_var;
}
...
void SCTPCookie::setLocalTag(uint32 localTag_var)
{
    this->localTag_var = localTag_var;
}
...
void SCTPCookie::setPeerTag(uint32 peerTag_var)
{
    this->peerTag_var = peerTag_var;
}
...
void SCTPCookie::setLocalTieTag(unsigned int k, uint8 localTieTag_var)
{
    if (k>=localTieTag_arraysize) throw cRuntimeError("Array of size %d indexed by %d", localTieTag_arraysize, k);
    this->localTieTag_var[k]=localTieTag_var;
}
...
void SCTPCookie::setPeerTieTag(unsigned int k, uint8 peerTieTag_var)
{
    if (k>=peerTieTag_arraysize) throw cRuntimeError("Array of size %d indexed by %d", peerTieTag_arraysize, k);
    this->peerTieTag_var[k]=peerTieTag_var;
}
...
const char *SCTPCookieDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        ...
        case 1: return "localTag";
        case 2: return "peerTag";
        case 3: return "localTieTag";
        case 4: return "peerTieTag";
        default: return NULL;
    }
}
...
bool SCTPCookieDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPCookie *pp = (SCTPCookie *)object; (void)pp;
    switch (field) {
        case 0: double2string(pp->getCreationTime(),resultbuf,bufsize); return true;
        case 1: ulong2string(pp->getLocalTag(),resultbuf,bufsize); return true;
        case 2: ulong2string(pp->getPeerTag(),resultbuf,bufsize); return true;
        case 3: ulong2string(pp->getLocalTieTag(i),resultbuf,bufsize); return true;
        case 4: ulong2string(pp->getPeerTieTag(i),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPCookieAckChunk::SCTPCookieAckChunk(const SCTPCookieAckChunk& other) : SCTPChunk()
{
    setName(other.getName());
    operator=(other);
}
...
bool SCTPCookieAckChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
SCTPDataMsg::SCTPDataMsg(const SCTPDataMsg& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPDataMsg::setEnqueuingTime(simtime_t enqueuingTime_var)
{
    this->enqueuingTime_var = enqueuingTime_var;
}
...
void SCTPDataMsg::setExpiryTime(simtime_t expiryTime_var)
{
    this->expiryTime_var = expiryTime_var;
}
...
void SCTPDataMsg::setPpid(uint32 ppid_var)
{
...
void SCTPDataMsg::setInitialDestination(const IPvXAddress& initialDestination_var)
{
    this->initialDestination_var = initialDestination_var;
}
...
void SCTPDataMsg::setMsgNum(uint32 msgNum_var)
{
    this->msgNum_var = msgNum_var;
}
...
void SCTPDataMsg::setSid(uint16 sid_var)
{
...
void SCTPDataMsg::setOrdered(bool ordered_var)
{
    this->ordered_var = ordered_var;
}
...
void SCTPDataMsg::setBooksize(uint32 booksize_var)
{
    this->booksize_var = booksize_var;
}
...
void SCTPDataMsg::setRtx(uint32 rtx_var)
{
    this->rtx_var = rtx_var;
}
...
const char *SCTPDataMsgDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return "enqueuingTime";
        case 1: return "expiryTime";
        case 2: return "ppid";
        case 3: return "initialDestination";
        case 4: return "msgNum";
        case 5: return "sid";
        case 6: return "ordered";
        case 7: return "booksize";
        case 8: return "rtx";
        default: return NULL;
    }
}
...
bool SCTPDataMsgDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPDataMsg *pp = (SCTPDataMsg *)object; (void)pp;
    switch (field) {
        case 0: double2string(pp->getEnqueuingTime(),resultbuf,bufsize); return true;
        case 1: double2string(pp->getExpiryTime(),resultbuf,bufsize); return true;
        case 2: ulong2string(pp->getPpid(),resultbuf,bufsize); return true;
        case 3: {std::stringstream out; out << pp->getInitialDestination(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 4: ulong2string(pp->getMsgNum(),resultbuf,bufsize); return true;
        case 5: ulong2string(pp->getSid(),resultbuf,bufsize); return true;
        case 6: bool2string(pp->getOrdered(),resultbuf,bufsize); return true;
        case 7: ulong2string(pp->getBooksize(),resultbuf,bufsize); return true;
        case 8: ulong2string(pp->getRtx(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
bool SCTPDataMsgDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    SCTPDataMsg *pp = (SCTPDataMsg *)object; (void)pp;
    switch (field) {
        case 0: pp->setEnqueuingTime(string2double(value)); return true;
        case 1: pp->setExpiryTime(string2double(value)); return true;
        case 2: pp->setPpid(string2ulong(value)); return true;
        case 4: pp->setMsgNum(string2ulong(value)); return true;
        case 5: pp->setSid(string2ulong(value)); return true;
        case 6: pp->setOrdered(string2bool(value)); return true;
        case 7: pp->setBooksize(string2ulong(value)); return true;
        case 8: pp->setRtx(string2ulong(value)); return true;
        default: return false;
    }
}
...
void *SCTPDataMsgDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    SCTPDataMsg *pp = (SCTPDataMsg *)object; (void)pp;
    switch (field) {
        case 3: return (void *)(&pp->getInitialDestination()); break;
        default: return NULL;
    }
}
...
SCTPDataChunk::SCTPDataChunk(const SCTPDataChunk& other) : SCTPChunk()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPDataChunk::setEBit(bool eBit_var)
{
    this->eBit_var = eBit_var;
}
...
void SCTPDataChunk::setBBit(bool bBit_var)
{
    this->bBit_var = bBit_var;
}
...
void SCTPDataChunk::setUBit(bool uBit_var)
{
    this->uBit_var = uBit_var;
}
...
void SCTPDataChunk::setTsn(uint32 tsn_var)
{
    this->tsn_var = tsn_var;
}
...
void SCTPDataChunk::setSid(uint16 sid_var)
{
    this->sid_var = sid_var;
}
...
void SCTPDataChunk::setSsn(uint16 ssn_var)
{
...
void SCTPDataChunk::setPpid(uint32 ppid_var)
{
    this->ppid_var = ppid_var;
}
...
void SCTPDataChunk::setEnqueuingTime(simtime_t enqueuingTime_var)
{
    this->enqueuingTime_var = enqueuingTime_var;
}
...
bool SCTPDataChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPDataChunk *pp = (SCTPDataChunk *)object; (void)pp;
    switch (field) {
        case 0: bool2string(pp->getEBit(),resultbuf,bufsize); return true;
        case 1: bool2string(pp->getBBit(),resultbuf,bufsize); return true;
        case 2: bool2string(pp->getUBit(),resultbuf,bufsize); return true;
        case 3: ulong2string(pp->getTsn(),resultbuf,bufsize); return true;
        case 4: ulong2string(pp->getSid(),resultbuf,bufsize); return true;
        case 5: ulong2string(pp->getSsn(),resultbuf,bufsize); return true;
        case 6: ulong2string(pp->getPpid(),resultbuf,bufsize); return true;
        case 7: double2string(pp->getEnqueuingTime(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPForwardTsnChunk::SCTPForwardTsnChunk(const SCTPForwardTsnChunk& other) : SCTPChunk()
{
    setName(other.getName());
    sid_arraysize = 0;
    this->sid_var = 0;
...
void SCTPForwardTsnChunk::setNewCumTsn(uint32 newCumTsn_var)
{
    this->newCumTsn_var = newCumTsn_var;
}
...
void SCTPForwardTsnChunk::setSid(unsigned int k, uint16 sid_var)
{
    if (k>=sid_arraysize) throw cRuntimeError("Array of size %d indexed by %d", sid_arraysize, k);
    this->sid_var[k]=sid_var;
}
...
void SCTPForwardTsnChunk::setSsn(unsigned int k, short ssn_var)
{
    if (k>=ssn_arraysize) throw cRuntimeError("Array of size %d indexed by %d", ssn_arraysize, k);
    this->ssn_var[k]=ssn_var;
}
...
bool SCTPForwardTsnChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPForwardTsnChunk *pp = (SCTPForwardTsnChunk *)object; (void)pp;
    switch (field) {
        case 0: ulong2string(pp->getNewCumTsn(),resultbuf,bufsize); return true;
        case 1: ulong2string(pp->getSid(i),resultbuf,bufsize); return true;
        case 2: long2string(pp->getSsn(i),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPSackChunk::SCTPSackChunk(const SCTPSackChunk& other) : SCTPChunk()
{
    setName(other.getName());
    gapStart_arraysize = 0;
    this->gapStart_var = 0;
...
void SCTPSackChunk::setCumTsnAck(uint32 cumTsnAck_var)
{
    this->cumTsnAck_var = cumTsnAck_var;
}
...
void SCTPSackChunk::setA_rwnd(uint32 a_rwnd_var)
{
    this->a_rwnd_var = a_rwnd_var;
}
...
void SCTPSackChunk::setNumGaps(uint16 numGaps_var)
{
    this->numGaps_var = numGaps_var;
}
...
void SCTPSackChunk::setNumDupTsns(uint16 numDupTsns_var)
{
    this->numDupTsns_var = numDupTsns_var;
}
...
void SCTPSackChunk::setGapStart(unsigned int k, uint32 gapStart_var)
{
    if (k>=gapStart_arraysize) throw cRuntimeError("Array of size %d indexed by %d", gapStart_arraysize, k);
    this->gapStart_var[k]=gapStart_var;
}
...
void SCTPSackChunk::setGapStop(unsigned int k, uint32 gapStop_var)
{
    if (k>=gapStop_arraysize) throw cRuntimeError("Array of size %d indexed by %d", gapStop_arraysize, k);
    this->gapStop_var[k]=gapStop_var;
}
...
void SCTPSackChunk::setDupTsns(unsigned int k, uint32 dupTsns_var)
{
    if (k>=dupTsns_arraysize) throw cRuntimeError("Array of size %d indexed by %d", dupTsns_arraysize, k);
    this->dupTsns_var[k]=dupTsns_var;
}
...
const char *SCTPSackChunkDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return "cumTsnAck";
        case 1: return "a_rwnd";
        case 2: return "numGaps";
        case 3: return "numDupTsns";
        case 4: return "gapStart";
        case 5: return "gapStop";
        case 6: return "dupTsns";
        default: return NULL;
    }
}
...
bool SCTPSackChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPSackChunk *pp = (SCTPSackChunk *)object; (void)pp;
    switch (field) {
        case 0: ulong2string(pp->getCumTsnAck(),resultbuf,bufsize); return true;
        case 1: ulong2string(pp->getA_rwnd(),resultbuf,bufsize); return true;
        case 2: ulong2string(pp->getNumGaps(),resultbuf,bufsize); return true;
        case 3: ulong2string(pp->getNumDupTsns(),resultbuf,bufsize); return true;
        case 4: ulong2string(pp->getGapStart(i),resultbuf,bufsize); return true;
        case 5: ulong2string(pp->getGapStop(i),resultbuf,bufsize); return true;
        case 6: ulong2string(pp->getDupTsns(i),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPAbortChunk::SCTPAbortChunk(const SCTPAbortChunk& other) : SCTPChunk()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPAbortChunk::setT_Bit(bool T_Bit_var)
{
    this->T_Bit_var = T_Bit_var;
}
...
bool SCTPAbortChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPAbortChunk *pp = (SCTPAbortChunk *)object; (void)pp;
    switch (field) {
        case 0: bool2string(pp->getT_Bit(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPHeartbeatChunk::SCTPHeartbeatChunk(const SCTPHeartbeatChunk& other) : SCTPChunk()
{
    setName(other.getName());
    info_arraysize = 0;
    this->info_var = 0;
...
void SCTPHeartbeatChunk::setRemoteAddr(const IPvXAddress& remoteAddr_var)
{
...
void SCTPHeartbeatChunk::setTimeField(simtime_t timeField_var)
{
    this->timeField_var = timeField_var;
}
...
void SCTPHeartbeatChunk::setInfo(unsigned int k, char info_var)
{
    if (k>=info_arraysize) throw cRuntimeError("Array of size %d indexed by %d", info_arraysize, k);
    this->info_var[k]=info_var;
}
...
bool SCTPHeartbeatChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 1: double2string(pp->getTimeField(),resultbuf,bufsize); return true;
        case 2: long2string(pp->getInfo(i),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPHeartbeatAckChunk::SCTPHeartbeatAckChunk(const SCTPHeartbeatAckChunk& other) : SCTPChunk()
{
    setName(other.getName());
    info_arraysize = 0;
    this->info_var = 0;
...
void SCTPHeartbeatAckChunk::setRemoteAddr(const IPvXAddress& remoteAddr_var)
{
    this->remoteAddr_var = remoteAddr_var;
}
...
void SCTPHeartbeatAckChunk::setTimeField(simtime_t timeField_var)
{
    this->timeField_var = timeField_var;
}
...
void SCTPHeartbeatAckChunk::setInfo(unsigned int k, char info_var)
{
    if (k>=info_arraysize) throw cRuntimeError("Array of size %d indexed by %d", info_arraysize, k);
    this->info_var[k]=info_var;
}
...
bool SCTPHeartbeatAckChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
SCTPShutdownChunk::SCTPShutdownChunk(const SCTPShutdownChunk& other) : SCTPChunk()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPShutdownChunk::setCumTsnAck(uint32 cumTsnAck_var)
{
    this->cumTsnAck_var = cumTsnAck_var;
}
...
bool SCTPShutdownChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
SCTPShutdownAckChunk::SCTPShutdownAckChunk(const SCTPShutdownAckChunk& other) : SCTPChunk()
{
    setName(other.getName());
    operator=(other);
}
...
bool SCTPShutdownAckChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
SCTPShutdownCompleteChunk::SCTPShutdownCompleteChunk(const SCTPShutdownCompleteChunk& other) : SCTPChunk()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPShutdownCompleteChunk::setTBit(bool TBit_var)
{
...
bool SCTPShutdownCompleteChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPShutdownCompleteChunk *pp = (SCTPShutdownCompleteChunk *)object; (void)pp;
    switch (field) {
        case 0: bool2string(pp->getTBit(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
SCTPErrorChunk_Base::SCTPErrorChunk_Base(const SCTPErrorChunk_Base& other) : SCTPChunk()
{
    setName(other.getName());
    operator=(other);
}
...
bool SCTPErrorChunkDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPErrorChunk_Base *pp = (SCTPErrorChunk_Base *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getParameters(i); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        default: return false;
    }
}
...
const char *SCTPErrorChunkDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return "cPacketPtr"; break;
        default: return NULL;
    }
}
...
SCTPParameter::SCTPParameter(const SCTPParameter& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPParameter::setParameterType(uint16 parameterType_var)
{
    this->parameterType_var = parameterType_var;
}
...
bool SCTPParameterDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    SCTPParameter *pp = (SCTPParameter *)object; (void)pp;
    switch (field) {
        case 0: ulong2string(pp->getParameterType(),resultbuf,bufsize); return true;
        default: return false;
    }
}
