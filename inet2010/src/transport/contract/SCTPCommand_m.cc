...
void SCTPOpenCommand::setInboundStreams(uint32 inboundStreams_var)
{
...
SCTPRcvCommand::SCTPRcvCommand(const SCTPRcvCommand& other) : SCTPCommand()
{
    setName(other.getName());
    operator=(other);
}
...
void SCTPRcvCommand::setPpid(uint32 ppid_var)
{
    this->ppid_var = ppid_var;
}
...
void SCTPRcvCommand::setTsn(uint32 tsn_var)
{
...
void SCTPRcvCommand::setCumTsn(uint32 cumTsn_var)
{
    this->cumTsn_var = cumTsn_var;
}
