...
public:
    ...
    int nodesInitialized; //!< nodes that have run initialize() and "registered" with GlobalStatistics
    int nodesFinished; //!< nodes that have run finished() and have "deregistered" with GlobalStatistics
     ...
     * needed because finish() gets called before all nodes have transmitted their data to GlobalStatistics
     */
    void doFinish();
