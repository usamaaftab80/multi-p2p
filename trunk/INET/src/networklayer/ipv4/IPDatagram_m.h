 ...
 * </pre>
 */
class INET_API IPRecordRouteOption : public cObject
{
  protected:
 ...
 * </pre>
 */
class INET_API IPTimestampOption : public cObject
{
  protected:
    int flag_var;
    short overflow_var;
 ...
 * </pre>
 */
class INET_API IPSourceRoutingOption : public cObject
{
  protected:
    IPAddress recordAddress_var[MAX_IPADDR_OPTION_ENTRIES];
    short nextAddressPtr_var;
 ...
 * </pre>
 */
class INET_API IPDatagram : public cPacket
{
  protected:
    short version_var;
