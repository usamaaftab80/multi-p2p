 ...
 * </pre>
 */
class INET_API RSVPResvMsg_Base : public ::RSVPPacket
{
  protected:
 ...
 * </pre>
 */
class INET_API RSVPResvTear_Base : public ::RSVPPacket
{
  protected:
    ::RsvpHopObj_t hop_var;
    ::FlowDescriptorVector flowDescriptor_var;
 ...
 * </pre>
 */
class INET_API RSVPResvError_Base : public ::RSVPPacket
{
  protected:
    ::RsvpHopObj_t hop_var;
