...
RSVPResvMsg_Base::RSVPResvMsg_Base(const RSVPResvMsg_Base& other) : RSVPPacket()
{
...
void RSVPResvMsg_Base::setHop(const RsvpHopObj_t& hop_var)
{
...
void RSVPResvMsg_Base::setFlowDescriptor(const FlowDescriptorVector& flowDescriptor_var)
{
    this->flowDescriptor_var = flowDescriptor_var;
}
...
void RSVPResvMsg_Base::setRsvpKind(int rsvpKind_var)
{
...
const char *RSVPResvMsgDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return "hop";
        case 1: return "flowDescriptor";
        case 2: return "rsvpKind";
        default: return NULL;
    }
}
...
const char *RSVPResvMsgDescriptor::getFieldTypeString(void *object, int field) const
{
    ...
    switch (field) {
        ...
        case 1: return "FlowDescriptorVector";
        case 2: return "int";
        default: return NULL;
    }
}
...
bool RSVPResvMsgDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 1: {std::stringstream out; out << pp->getFlowDescriptor(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 2: long2string(pp->getRsvpKind(),resultbuf,bufsize); return true;
...
const char *RSVPResvMsgDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        ...
        case 1: return "FlowDescriptorVector"; break;
        default: return NULL;
    }
}
...
RSVPResvTear_Base::RSVPResvTear_Base(const RSVPResvTear_Base& other) : RSVPPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void RSVPResvTear_Base::setHop(const RsvpHopObj_t& hop_var)
{
    this->hop_var = hop_var;
}
...
void RSVPResvTear_Base::setFlowDescriptor(const FlowDescriptorVector& flowDescriptor_var)
{
    this->flowDescriptor_var = flowDescriptor_var;
}
...
void RSVPResvTear_Base::setRsvpKind(int rsvpKind_var)
{
    this->rsvpKind_var = rsvpKind_var;
}
...
bool RSVPResvTearDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
RSVPResvError_Base::RSVPResvError_Base(const RSVPResvError_Base& other) : RSVPPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void RSVPResvError_Base::setHop(const RsvpHopObj_t& hop_var)
{
    this->hop_var = hop_var;
}
...
void RSVPResvError_Base::setErrorNode(const IPAddress& errorNode_var)
{
...
void RSVPResvError_Base::setErrorCode(int errorCode_var)
{
...
void RSVPResvError_Base::setRsvpKind(int rsvpKind_var)
{
    this->rsvpKind_var = rsvpKind_var;
}
...
bool RSVPResvErrorDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: {std::stringstream out; out << pp->getHop(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 1: {std::stringstream out; out << pp->getErrorNode(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 2: long2string(pp->getErrorCode(),resultbuf,bufsize); return true;
