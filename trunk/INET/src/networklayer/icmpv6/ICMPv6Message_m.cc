...
ICMPv6Message::ICMPv6Message(const ICMPv6Message& other) : cPacket()
{
...
void ICMPv6Message::setType(int type_var)
{
...
bool ICMPv6MessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
ICMPv6DestUnreachableMsg::ICMPv6DestUnreachableMsg(const ICMPv6DestUnreachableMsg& other) : ICMPv6Message()
{
    setName(other.getName());
    operator=(other);
}
...
void ICMPv6DestUnreachableMsg::setCode(int code_var)
{
...
bool ICMPv6DestUnreachableMsgDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
ICMPv6PacketTooBigMsg::ICMPv6PacketTooBigMsg(const ICMPv6PacketTooBigMsg& other) : ICMPv6Message()
{
    setName(other.getName());
    operator=(other);
}
...
void ICMPv6PacketTooBigMsg::setCode(int code_var)
{
    this->code_var = code_var;
}
...
void ICMPv6PacketTooBigMsg::setMTU(int MTU_var)
{
...
bool ICMPv6PacketTooBigMsgDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: long2string(pp->getCode(),resultbuf,bufsize); return true;
        case 1: long2string(pp->getMTU(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
ICMPv6TimeExceededMsg::ICMPv6TimeExceededMsg(const ICMPv6TimeExceededMsg& other) : ICMPv6Message()
{
    setName(other.getName());
    operator=(other);
}
...
void ICMPv6TimeExceededMsg::setCode(int code_var)
{
    this->code_var = code_var;
}
...
bool ICMPv6TimeExceededMsgDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
ICMPv6ParamProblemMsg::ICMPv6ParamProblemMsg(const ICMPv6ParamProblemMsg& other) : ICMPv6Message()
{
    setName(other.getName());
    operator=(other);
}
...
void ICMPv6ParamProblemMsg::setCode(int code_var)
{
    this->code_var = code_var;
}
...
bool ICMPv6ParamProblemMsgDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
ICMPv6EchoRequestMsg::ICMPv6EchoRequestMsg(const ICMPv6EchoRequestMsg& other) : ICMPv6Message()
{
    setName(other.getName());
    operator=(other);
}
...
void ICMPv6EchoRequestMsg::setCode(int code_var)
{
    this->code_var = code_var;
}
...
void ICMPv6EchoRequestMsg::setIdentifier(int identifier_var)
{
...
void ICMPv6EchoRequestMsg::setSeqNumber(int seqNumber_var)
{
...
bool ICMPv6EchoRequestMsgDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: long2string(pp->getCode(),resultbuf,bufsize); return true;
        case 1: long2string(pp->getIdentifier(),resultbuf,bufsize); return true;
        case 2: long2string(pp->getSeqNumber(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
ICMPv6EchoReplyMsg::ICMPv6EchoReplyMsg(const ICMPv6EchoReplyMsg& other) : ICMPv6Message()
{
    setName(other.getName());
    operator=(other);
}
...
void ICMPv6EchoReplyMsg::setCode(int code_var)
{
    this->code_var = code_var;
}
...
void ICMPv6EchoReplyMsg::setIdentifier(int identifier_var)
{
    this->identifier_var = identifier_var;
}
...
void ICMPv6EchoReplyMsg::setSeqNumber(int seqNumber_var)
{
    this->seqNumber_var = seqNumber_var;
}
...
bool ICMPv6EchoReplyMsgDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
