...
GenericAppMsg::GenericAppMsg(const GenericAppMsg& other) : cPacket()
{
...
void GenericAppMsg::setExpectedReplyLength(int expectedReplyLength_var)
{
    this->expectedReplyLength_var = expectedReplyLength_var;
}
...
void GenericAppMsg::setReplyDelay(double replyDelay_var)
{
    this->replyDelay_var = replyDelay_var;
}
...
void GenericAppMsg::setServerClose(bool serverClose_var)
{
    this->serverClose_var = serverClose_var;
}
