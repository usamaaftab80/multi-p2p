//
// Generated file, do not edit! Created by opp_msgc 4.0 from applications/scribe/ScribeMessage.msg.
//
...
ScribeJoinCall::ScribeJoinCall(const ScribeJoinCall& other) : BaseCallMessage()
{
...
void ScribeJoinCall::setGroupId(const OverlayKey& groupId_var)
{
...
bool ScribeJoinCallDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
ScribeJoinResponse::ScribeJoinResponse(const ScribeJoinResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void ScribeJoinResponse::setGroupId(const OverlayKey& groupId_var)
{
    this->groupId_var = groupId_var;
}
...
bool ScribeJoinResponseDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
ScribePublishCall::ScribePublishCall(const ScribePublishCall& other) : BaseCallMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void ScribePublishCall::setGroupId(const OverlayKey& groupId_var)
{
    this->groupId_var = groupId_var;
}
...
bool ScribePublishCallDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
ScribePublishResponse::ScribePublishResponse(const ScribePublishResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void ScribePublishResponse::setGroupId(const OverlayKey& groupId_var)
{
    this->groupId_var = groupId_var;
}
...
void ScribePublishResponse::setWrongRoot(bool wrongRoot_var)
{
...
bool ScribePublishResponseDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: {std::stringstream out; out << pp->getGroupId(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 1: bool2string(pp->getWrongRoot(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
ScribeSubscriptionRefreshMessage::ScribeSubscriptionRefreshMessage(const ScribeSubscriptionRefreshMessage& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void ScribeSubscriptionRefreshMessage::setSrc(const NodeHandle& src_var)
{
...
void ScribeSubscriptionRefreshMessage::setGroupId(const OverlayKey& groupId_var)
{
    this->groupId_var = groupId_var;
}
...
bool ScribeSubscriptionRefreshMessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 1: {std::stringstream out; out << pp->getGroupId(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        default: return false;
    }
}
...
ScribeLeaveMessage::ScribeLeaveMessage(const ScribeLeaveMessage& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void ScribeLeaveMessage::setSrc(const NodeHandle& src_var)
{
    this->src_var = src_var;
}
...
void ScribeLeaveMessage::setGroupId(const OverlayKey& groupId_var)
{
    this->groupId_var = groupId_var;
}
...
bool ScribeLeaveMessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
ScribeTimer::ScribeTimer(const ScribeTimer& other) : cMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void ScribeTimer::setTimerType(int timerType_var)
{
...
void ScribeTimer::setChild(const NodeHandle& child_var)
{
...
void ScribeTimer::setGroup(const OverlayKey& group_var)
{
...
bool ScribeTimerDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    ScribeTimer *pp = (ScribeTimer *)object; (void)pp;
    switch (field) {
        case 0: long2string(pp->getTimerType(),resultbuf,bufsize); return true;
        case 1: {std::stringstream out; out << pp->getChild(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 2: {std::stringstream out; out << pp->getGroup(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        default: return false;
    }
}
...
ScribeDataMessage::ScribeDataMessage(const ScribeDataMessage& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void ScribeDataMessage::setGroupId(const OverlayKey& groupId_var)
{
    this->groupId_var = groupId_var;
}
...
void ScribeDataMessage::setEmpty(bool empty_var)
{
...
bool ScribeDataMessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: {std::stringstream out; out << pp->getGroupId(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 1: bool2string(pp->getEmpty(),resultbuf,bufsize); return true;
        default: return false;
    }
}
