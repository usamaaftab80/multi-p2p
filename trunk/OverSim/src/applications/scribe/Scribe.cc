                               ...
                               simtime_t rtt)
{
    ...
    RPC_ON_RESPONSE( ScribeJoin ) {
        ...
        EV << "[Scribe::handleRpcResponse() @ " << overlay->getThisNode().getAddress()
...
void Scribe::handleUpperMessage( cMessage *msg )
{
    if( ALMSubscribeMessage* subscribeMsg = dynamic_cast<ALMSubscribeMessage*>(msg)){
        ...
        EV << "[Scribe::handleUpperMessage() @ " << overlay->getThisNode().getAddress()
            << " (" << overlay->getThisNode().getKey().toString(16) << ")]\n"
...
void Scribe::handleTimerEvent( cMessage *msg )
{
    ...
    switch( timer->getTimerType() ) {
        ...
        case SCRIBE_PARENT_TIMEOUT:
            ...
            EV << "[Scribe::handleTimerEvent() @ " << overlay->getThisNode().getAddress()
                << " (" << overlay->getThisNode().getKey().toString(16) << ")]\n"
                << "    Parent of group " << key << "\n"
...
void Scribe::handleJoinMessage( ScribeJoinCall* joinMsg, bool amIRoot)
{
    ...
    EV << "[Scribe::handleJoinMessage() @ " << overlay->getThisNode().getAddress()
        << " (" << overlay->getThisNode().getKey().toString(16) << ")]\n"
...
void Scribe::handlePublishCall( ScribePublishCall* publishCall )
{
    ...
    if( it == groupList.end() ||
        ...
        if( !data ) {
            ...
            EV << "[Scribe::handlePublishCall() @ " << overlay->getThisNode().getAddress()
                << " (" << overlay->getThisNode().getKey().toString(16) << ")]\n"
...
void Scribe::handleJoinResponse( ScribeJoinResponse* joinResponse )
{
    ...
    if( it == groupList.end() ) {
        EV << "[Scribe::handleJoinResponse() @ " << overlay->getThisNode().getAddress()
            << " (" << overlay->getThisNode().getKey().toString(16) << ")]\n"
...
void Scribe::handlePublishResponse( ScribePublishResponse* publishResponse )
{
    ...
    if( it == groupList.end() ) {
        EV << "[Scribe::handlePublishResponse() @ " << overlay->getThisNode().getAddress()
            << " (" << overlay->getThisNode().getKey().toString(16) << ")]\n"
...
{
    EV << "[Scribe::subscribeToGroup() @ " << overlay->getThisNode().getAddress()
        << " (" << overlay->getThisNode().getKey().toString(16) << ")]\n"
...
void Scribe::deliverALMDataToGroup( ScribeDataMessage* dataMsg )
{
    ...
    if( it == groupList.end() ) {
        EV << "[Scribe::deliverALMDataToGroup() @ " << overlay->getThisNode().getAddress()
