//
// Generated file, do not edit! Created by opp_msgc 4.0 from overlay/chord/ChordMessage.msg.
//
...
ChordMessage::ChordMessage(const ChordMessage& other) : BaseOverlayMessage()
{
...
void ChordMessage::setCommand(int command_var)
{
...
bool ChordMessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
NewSuccessorHintMessage::NewSuccessorHintMessage(const NewSuccessorHintMessage& other) : ChordMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NewSuccessorHintMessage::setSrcNode(const NodeHandle& srcNode_var)
{
...
void NewSuccessorHintMessage::setPreNode(const NodeHandle& preNode_var)
{
...
bool NewSuccessorHintMessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
NotifyCall::NotifyCall(const NotifyCall& other) : BaseCallMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void NotifyCall::setFailed(const TransportAddress& failed_var)
{
...
bool NotifyCallDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    NotifyCall *pp = (NotifyCall *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getFailed(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        default: return false;
    }
}
...
NotifyResponse::NotifyResponse(const NotifyResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    sucNode_arraysize = 0;
    this->sucNode_var = 0;
...
void NotifyResponse::setSucNum(int sucNum_var)
{
...
void NotifyResponse::setSucNode(unsigned int k, const NodeHandle& sucNode_var)
{
    if (k>=sucNode_arraysize) throw cRuntimeError("Array of size %d indexed by %d", sucNode_arraysize, k);
...
void NotifyResponse::setPreNode(const NodeHandle& preNode_var)
{
    this->preNode_var = preNode_var;
}
...
void NotifyResponse::setPreNodeSet(bool preNodeSet_var)
{
    this->preNodeSet_var = preNodeSet_var;
}
...
bool NotifyResponseDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        ...
        case 3: bool2string(pp->getPreNodeSet(),resultbuf,bufsize); return true;
        default: return false;
    }
}
...
JoinCall::JoinCall(const JoinCall& other) : BaseCallMessage()
{
    setName(other.getName());
    operator=(other);
}
...
bool JoinCallDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
JoinResponse::JoinResponse(const JoinResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    sucNode_arraysize = 0;
    this->sucNode_var = 0;
...
void JoinResponse::setSucNum(int sucNum_var)
{
    this->sucNum_var = sucNum_var;
}
...
void JoinResponse::setSucNode(unsigned int k, const NodeHandle& sucNode_var)
{
    if (k>=sucNode_arraysize) throw cRuntimeError("Array of size %d indexed by %d", sucNode_arraysize, k);
    this->sucNode_var[k]=sucNode_var;
}
...
void JoinResponse::setPreNode(const NodeHandle& preNode_var)
{
    this->preNode_var = preNode_var;
}
...
bool JoinResponseDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
StabilizeCall::StabilizeCall(const StabilizeCall& other) : BaseCallMessage()
{
    setName(other.getName());
    operator=(other);
}
...
bool StabilizeCallDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
StabilizeResponse::StabilizeResponse(const StabilizeResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void StabilizeResponse::setPreNode(const NodeHandle& preNode_var)
{
    this->preNode_var = preNode_var;
}
...
bool StabilizeResponseDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    StabilizeResponse *pp = (StabilizeResponse *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getPreNode(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        default: return false;
    }
}
...
FixfingersCall::FixfingersCall(const FixfingersCall& other) : BaseCallMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void FixfingersCall::setFinger(int finger_var)
{
...
bool FixfingersCallDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
FixfingersResponse::FixfingersResponse(const FixfingersResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    sucNode_arraysize = 0;
    this->sucNode_var = 0;
...
void FixfingersResponse::setFinger(int finger_var)
{
    this->finger_var = finger_var;
}
...
void FixfingersResponse::setSucNode(unsigned int k, const NodeHandle& sucNode_var)
{
    if (k>=sucNode_arraysize) throw cRuntimeError("Array of size %d indexed by %d", sucNode_arraysize, k);
    this->sucNode_var[k]=sucNode_var;
}
...
bool FixfingersResponseDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
KoordeFindNodeExtMessage::KoordeFindNodeExtMessage(const KoordeFindNodeExtMessage& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}
...
void KoordeFindNodeExtMessage::setRouteKey(const OverlayKey& routeKey_var)
{
...
void KoordeFindNodeExtMessage::setStep(int step_var)
{
...
bool KoordeFindNodeExtMessageDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
DeBruijnCall::DeBruijnCall(const DeBruijnCall& other) : BaseCallMessage()
{
    setName(other.getName());
    operator=(other);
}
...
void DeBruijnCall::setDestKey(const OverlayKey& destKey_var)
{
...
bool DeBruijnCallDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
DeBruijnResponse::DeBruijnResponse(const DeBruijnResponse& other) : BaseResponseMessage()
{
    setName(other.getName());
    sucNode_arraysize = 0;
    this->sucNode_var = 0;
...
void DeBruijnResponse::setDBNode(const NodeHandle& dBNode_var)
{
    this->dBNode_var = dBNode_var;
}
...
void DeBruijnResponse::setSucNum(int sucNum_var)
{
    this->sucNum_var = sucNum_var;
}
...
void DeBruijnResponse::setSucNode(unsigned int k, const NodeHandle& sucNode_var)
{
    if (k>=sucNode_arraysize) throw cRuntimeError("Array of size %d indexed by %d", sucNode_arraysize, k);
    this->sucNode_var[k]=sucNode_var;
}
...
const char *DeBruijnResponseDescriptor::getFieldName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return "dBNode";
        case 1: return "sucNum";
        case 2: return "sucNode";
        default: return NULL;
    }
}
...
bool DeBruijnResponseDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    DeBruijnResponse *pp = (DeBruijnResponse *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getDBNode(); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        case 1: long2string(pp->getSucNum(),resultbuf,bufsize); return true;
        case 2: {std::stringstream out; out << pp->getSucNode(i); opp_strprettytrunc(resultbuf,out.str().c_str(),bufsize-1); return true;}
        default: return false;
    }
}
