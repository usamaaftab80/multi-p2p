...
enum INIT_STAGES
{
    ...
    MIN_STAGE_COMPONENTS = 5,
    MAX_STAGE_COMPONENTS = 6,
    NUM_STAGES_COMPONENTS = MAX_STAGE_COMPONENTS - MIN_STAGE_COMPONENTS,
    MIN_STAGE_OVERLAY = 7, /**< first stage for overlay modules
			      (Tier 0 / KBR) */
    MAX_STAGE_OVERLAY = 8, /**< last stage for overlay modules
			      (Tier 0 / KBR) */
    NUM_STAGES_OVERLAY
    ...
    MIN_STAGE_APP = 9, /**< deprecated */
    MAX_STAGE_APP = 10, /**< deprecated */
    NUM_STAGES_APP = MAX_STAGE_APP - MIN_STAGE_APP + 1, /**< deprecated */

    MIN_STAGE_TIER_1 = 9, /**< first stage for overlay application modules
			  (Tier 1) */
    MAX_STAGE_TIER_1 = 10, /**< last stage for overlay application modules
			  (Tier 1) */
    NUM_STAGES_TIER_1
    = MAX_STAGE_TIER_1 - MIN_STAGE_TIER_1 + 1, /**< number of stages for overlay
						  application modules (Tier 1) */

    MIN_STAGE_TIER_2 = 11, /**< first stage for overlay application modules
			  (Tier 2) */
    MAX_STAGE_TIER_2 = 12, /**< last stage for overlay application modules
			  (Tier 2) */
    NUM_STAGES_TIER_2
    = MAX_STAGE_TIER_2 - MIN_STAGE_TIER_2 + 1, /**< number of stages for overlay
						  application modules (Tier 2) */

    MIN_STAGE_TIER_3 = 13, /**< first stage for overlay application modules
			  (Tier 3) */
    MAX_STAGE_TIER_3 = 14, /**< last stage for overlay application modules
			  (Tier 3) */
    NUM_STAGES_TIER_3
