...
NiceMulticastMessage::NiceMulticastMessage(const char *name, int kind) : BaseOverlayMessage(name,kind)
{
    this->sendTime_var = 0;
    this->seqNo_var = 0;
    this->hopCount_var = 0;
...
void NiceMulticastMessage::setLastHop(const TransportAddress& lastHop_var)
{
...
void NiceMulticastMessage::setSendTime(double sendTime_var)
{
...
void NiceMulticastMessage::setSeqNo(unsigned int seqNo_var)
{
    this->seqNo_var = seqNo_var;
}
...
void NiceMulticastMessage::setHopCount(unsigned int hopCount_var)
{
    this->hopCount_var = hopCount_var;
}

double NiceMulticastMessage::getBigKD() const
{
    return bigKD_var;
}

void NiceMulticastMessage::setBigKD(double bigKD_var)
{
    this->bigKD_var = bigKD_var;
}

double NiceMulticastMessage::getLastHopKd() const
{
...
int NiceMulticastMessage::getNodeID() const
{
    return nodeID_var;
}

void NiceMulticastMessage::setNodeID(int nodeID_var)
{
...
void NiceMulticastMessage::setLastHopID(int lastHopID_var)
{
    this->lastHopID_var = lastHopID_var;
}

int NiceMulticastMessage::getCommand() const
{
    return command_var;
}

void NiceMulticastMessage::setCommand(int command_var)
{
    this->command_var = command_var;
}

TransportAddress& NiceMulticastMessage::getSrcNode()
{
    return srcNode_var;
}

void NiceMulticastMessage::setSrcNode(const TransportAddress& srcNode_var)
{
    this->srcNode_var = srcNode_var;
}

short NiceMulticastMessage::getLayer() const
{
    return layer_var;
}

void NiceMulticastMessage::setLayer(short layer_var)
{
    this->layer_var = layer_var;
}
...
NiceMulticastMessageDescriptor::NiceMulticastMessageDescriptor() : cClassDescriptor("NiceMulticastMessage", "BaseOverlayMessage")
{
}
...
int NiceMulticastMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "nodeID")==0) return base+6;
...
std::string NiceMulticastMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 6: return long2string(pp->getNodeID());
...
bool NiceMulticastMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 6: pp->setNodeID(string2long(value)); return true;
