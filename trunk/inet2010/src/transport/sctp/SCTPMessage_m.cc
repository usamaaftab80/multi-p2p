...
void SCTPDataMsg::setEBit(bool eBit_var)
{
...
void SCTPDataMsg::setBBit(bool bBit_var)
{
...
void SCTPDataMsg::setFragment(bool fragment_var)
{
    this->fragment_var = fragment_var;
}
...
void SCTPSackChunk::setSackSeqNum(uint32 sackSeqNum_var)
{
    this->sackSeqNum_var = sackSeqNum_var;
}
...
void SCTPErrorChunk_Base::setTBit(bool TBit_var)
{
    this->TBit_var = TBit_var;
}
...
void SCTPErrorChunk_Base::setMBit(bool MBit_var)
{
    this->MBit_var = MBit_var;
}
