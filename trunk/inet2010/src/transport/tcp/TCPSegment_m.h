...
class Sack : public ::cObject
{
  ...
  public:
    ...
    virtual void setStart(unsigned int start_var);
    virtual unsigned int getEnd() const;
    virtual void setEnd(unsigned int end_var);
};
...
class TCPOption : public ::cObject
{
  ...
  public:
    ...
    virtual void setKind(unsigned short kind_var);
    ...
    virtual void setValues(unsigned int k, unsigned int values_var);
};
...
class TCPSegment_Base : public ::cPacket
{
  ...
  public:
    ...
    virtual void setSrcPort(unsigned short srcPort_var);
    virtual unsigned short getDestPort() const;
    virtual void setDestPort(unsigned short destPort_var);
    ...
    virtual void setHeaderLength(unsigned short headerLength_var);
    ...
    virtual void setWindow(unsigned short window_var);
    virtual unsigned short getUrgentPointer() const;
    virtual void setUrgentPointer(unsigned short urgentPointer_var);
    ...
    virtual void setOptions(unsigned int k, const TCPOption& options_var);
    virtual unsigned long getPayloadLength() const;
    virtual void setPayloadLength(unsigned long payloadLength_var);
