...
Sack::Sack(const Sack& other) : cObject()
{
    operator=(other);
}
...
void Sack::setStart(unsigned int start_var)
{
...
void Sack::setEnd(unsigned int end_var)
{
...
TCPOption::TCPOption(const TCPOption& other) : cObject()
{
    values_arraysize = 0;
    this->values_var = 0;
    operator=(other);
...
void TCPOption::setKind(unsigned short kind_var)
{
...
void TCPOption::setLength(unsigned short length_var)
{
...
void TCPOption::setValues(unsigned int k, unsigned int values_var)
{
    if (k>=values_arraysize) throw cRuntimeError("Array of size %d indexed by %d", values_arraysize, k);
    this->values_var[k]=values_var;
}
...
void TCPSegment_Base::setSrcPort(unsigned short srcPort_var)
{
...
void TCPSegment_Base::setDestPort(unsigned short destPort_var)
{
...
void TCPSegment_Base::setHeaderLength(unsigned short headerLength_var)
{
...
void TCPSegment_Base::setWindow(unsigned short window_var)
{
...
void TCPSegment_Base::setUrgentPointer(unsigned short urgentPointer_var)
{
...
void TCPSegment_Base::setOptions(unsigned int k, const TCPOption& options_var)
{
    if (k>=options_arraysize) throw cRuntimeError("Array of size %d indexed by %d", options_arraysize, k);
    this->options_var[k]=options_var;
}
...
void TCPSegment_Base::setPayloadLength(unsigned long payloadLength_var)
{
