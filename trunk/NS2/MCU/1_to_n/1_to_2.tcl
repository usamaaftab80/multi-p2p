...
$ns attach-agent $s2 $null2
$ns connect $udp2 $null2
$null2 set_filename rd_paris_2

##
set original_file_name_1 st_paris
set trace_file_name_1 video_1.dat
set original_file_id_1 [open $original_file_name_1 r]
set trace_file_id_1 [open $trace_file_name_1 w]

set pre_time 0

while {[eof $original_file_id_1] == 0} {
    gets $original_file_id_1 current_line
    ...
    puts  $trace_file_id_1 "$time $length_ $type_v $prio_p $max_fragmented_size"
    set pre_time $tmp2_
}

close $original_file_id_1
close $trace_file_id_1
set end_sim_time $tmp2_
puts "$end_sim_time"

set trace_file_1 [new Tracefile]
$trace_file_1 filename $trace_file_name_1
##

##
set original_file_name_2 st_paris
set trace_file_name_2 video_2.dat
set original_file_id_2 [open $original_file_name_2 r]
set trace_file_id_2 [open $trace_file_name_2 w]

set pre_time 0

while {[eof $original_file_id_2] == 0} {
    gets $original_file_id_2 current_line
    ...
    puts  $trace_file_id_2 "$time $length_ $type_v $prio_p $max_fragmented_size"
    set pre_time $tmp2_
}

close $original_file_id_2
close $trace_file_id_2
set end_sim_time $tmp2_
puts "$end_sim_time"

set trace_file_2 [new Tracefile]
$trace_file_2 filename $trace_file_name_2
##
