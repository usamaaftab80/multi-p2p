...
!ifndef _isEmptyDir_nsh
!define _isEmptyDir_nsh

; Macro 
;http://nsis.sourceforge.net/wiki/Delete_dir_only_if_empty
...
FunctionEnd
!macroend
!insertmacro isEmptyDir ""
!insertmacro isEmptyDir "un."

!endif ; _isEmptyDir_nsh 