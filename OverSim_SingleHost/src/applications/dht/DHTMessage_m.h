...
class DHTPutCall : public ::BaseCallMessage
{
  ...
  public:
    ...
    virtual void setMaintenance(bool maintenance_var);
...
class DHTPutResponse : public ::BaseResponseMessage
{
  ...
  public:
    ...
    // field getter/setter methods
    virtual OverlayKey& getKey();
    virtual const OverlayKey& getKey() const {return const_cast<DHTPutResponse*>(this)->getKey();}
    virtual void setKey(const OverlayKey& key_var);
    virtual BinaryValue& getValue();
    virtual const BinaryValue& getValue() const {return const_cast<DHTPutResponse*>(this)->getValue();}
    virtual void setValue(const BinaryValue& value_var);
};
