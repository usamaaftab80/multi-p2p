...
Register_Class(MultiSenderAppMsg);

MultiSenderAppMsg::MultiSenderAppMsg(const char *name, int kind) : cPacket(name,kind)
{
    this->type_var = 0;
    this->senderID_var = 0;
    this->data_var = 0;
...
MultiSenderAppMsg::MultiSenderAppMsg(const MultiSenderAppMsg& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}

MultiSenderAppMsg::~MultiSenderAppMsg()
{
}

MultiSenderAppMsg& MultiSenderAppMsg::operator=(const MultiSenderAppMsg& other)
{
...
void MultiSenderAppMsg::parsimPack(cCommBuffer *b)
{
...
void MultiSenderAppMsg::parsimUnpack(cCommBuffer *b)
{
...
int MultiSenderAppMsg::getType() const
{
    return type_var;
}

void MultiSenderAppMsg::setType(int type_var)
{
    this->type_var = type_var;
}

TransportAddress& MultiSenderAppMsg::getSenderAddress()
{
    return senderAddress_var;
}

void MultiSenderAppMsg::setSenderAddress(const TransportAddress& senderAddress_var)
{
    this->senderAddress_var = senderAddress_var;
}

int MultiSenderAppMsg::getSenderID() const
{
    return senderID_var;
}

void MultiSenderAppMsg::setSenderID(int senderID_var)
{
    this->senderID_var = senderID_var;
}

const char * MultiSenderAppMsg::getData() const
{
    return data_var.c_str();
}

void MultiSenderAppMsg::setData(const char * data_var)
{
    this->data_var = data_var;
}

int MultiSenderAppMsg::getId() const
{
    return id_var;
}

void MultiSenderAppMsg::setId(int id_var)
{
    this->id_var = id_var;
}

class MultiSenderAppMsgDescriptor : public cClassDescriptor
{
  public:
    MultiSenderAppMsgDescriptor();
    virtual ~MultiSenderAppMsgDescriptor();
...
Register_ClassDescriptor(MultiSenderAppMsgDescriptor);

MultiSenderAppMsgDescriptor::MultiSenderAppMsgDescriptor() : cClassDescriptor("MultiSenderAppMsg", "cPacket")
{
}

MultiSenderAppMsgDescriptor::~MultiSenderAppMsgDescriptor()
{
}

bool MultiSenderAppMsgDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<MultiSenderAppMsg *>(obj)!=NULL;
}

const char *MultiSenderAppMsgDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int MultiSenderAppMsgDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 5+basedesc->getFieldCount(object) : 5;
}

unsigned int MultiSenderAppMsgDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
int MultiSenderAppMsgDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool MultiSenderAppMsgDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *MultiSenderAppMsgDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
