                                   ...
                                   DHTStatsContext* context)
{
    ...
    RECORD_STATS(globalStatistics->addStdDev("DHTTestApp: PUT delay (s)",
                                   ...
                                   DHTStatsContext* context)
{
    ...
    RECORD_STATS(globalStatistics->addStdDev("DHTTestApp: GET delay (s)",
                                             SIMTIME_DBL(simTime() - context->requestTime)));
...
void DHTTestApp::handleTimerEvent(cMessage* msg)
{
    if (msg->isName("dhttest_put_timer")) {
        ...
        if (key.isUnspecified()) {
            EV << "[DHTTestApp::handleTimerEvent() @ " << thisNode.getAddress()
