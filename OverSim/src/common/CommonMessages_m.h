...
class BaseRouteMessage : public BaseOverlayMessage
{
  protected:
    ...
    NodeHandle *hints_var; // array ptr
  ...
  public:
    ...
    virtual NodeHandle& getHints(unsigned int k);
    virtual const NodeHandle& getHints(unsigned int k) const {return const_cast<BaseRouteMessage*>(this)->getHints(k);}
...
class BaseRpcMessage : public BaseOverlayMessage
{
  ...
  public:
    ...
    virtual const AuthBlock& getAuthBlock(unsigned int k) const {return const_cast<BaseRpcMessage*>(this)->getAuthBlock(k);}
...
class BaseResponseMessage : public BaseRpcMessage
{
  protected:
    ...
    double *coords_var; // array ptr
    unsigned int coords_arraysize;
    double error_var;
  ...
  public:
    ...
    virtual void setCallHopCount(int callHopCount_var);
    virtual void setCoordsArraySize(unsigned int size);
    virtual unsigned int getCoordsArraySize() const;
    virtual double getCoords(unsigned int k) const;
    virtual void setCoords(unsigned int k, double coords_var);
    virtual double getError() const;
    virtual void setError(double error_var);
};
...
class FailedNodeCall : public BaseCallMessage
{
  ...
  public:
    ...
    virtual void setFailedNode(const TransportAddress& failedNode_var);
};
...
class FailedNodeResponse : public BaseResponseMessage
{
  ...
  public:
    ...
    virtual void setTryAgain(bool tryAgain_var);
};
...
class CompReadyMessage : public cPacket
{
  ...
  public:
    ...
    virtual void setReady(bool ready_var);
    virtual int getComp() const;
    virtual void setComp(int comp_var);
};
...
class DhtDumpEntry : public cObject
{
  ...
  public:
    ...
    virtual void setValue(const BinaryValue& value_var);
    ...
    virtual void setOwnerNode(const NodeHandle& ownerNode_var);
    virtual bool getIs_modifiable() const;
    virtual void setIs_modifiable(bool is_modifiable_var);
    virtual bool getResponsible() const;
    virtual void setResponsible(bool responsible_var);
};
...
class DHTputCAPICall : public BaseCallMessage
{
  ...
  public:
    ...
    virtual void setIsModifiable(bool isModifiable_var);
};
...
class DHTputCAPIResponse : public BaseResponseMessage
{
  ...
  public:
    ...
    // field getter/setter methods
    virtual OverlayKey& getKey();
    virtual const OverlayKey& getKey() const {return const_cast<DHTputCAPIResponse*>(this)->getKey();}
    virtual void setKey(const OverlayKey& key_var);
    virtual BinaryValue& getValue();
    virtual const BinaryValue& getValue() const {return const_cast<DHTputCAPIResponse*>(this)->getValue();}
    virtual void setValue(const BinaryValue& value_var);
...
class DHTdumpResponse : public BaseResponseMessage
{
  ...
  public:
    ...
    virtual void setRecord(unsigned int k, const DhtDumpEntry& record_var);
};
...
class P2pnsResolveResponse : public BaseResponseMessage
{
  ...
  public:
    ...
    virtual void setAddress(unsigned int k, const BinaryValue& address_var);
    ...
    virtual void setKind(unsigned int k, uint32_t kind_var);
    ...
    virtual void setId(unsigned int k, uint32_t id_var);
    virtual bool getIsSuccess() const;
    virtual void setIsSuccess(bool isSuccess_var);
};
...
class GameAPIChatMessage : public GameAPIMessage
{
  ...
  public:
    ...
    virtual void setMsg(const char * msg_var);
};
...
class GameAPISnowMessage : public GameAPIMessage
{
  ...
  public:
    ...
    virtual void setStart(const Vector2D& start_var);
    virtual Vector2D& getEnd();
    virtual const Vector2D& getEnd() const {return const_cast<GameAPISnowMessage*>(this)->getEnd();}
    virtual void setEnd(const Vector2D& end_var);
    virtual int getTimeSec() const;
    virtual void setTimeSec(int timeSec_var);
    virtual int getTimeUsec() const;
    virtual void setTimeUsec(int timeUsec_var);
};
...
class GameAPIFrozenMessage : public GameAPIMessage
{
  ...
  public:
    ...
    virtual void setThrower(int thrower_var);
    virtual int getTimeSec() const;
    virtual void setTimeSec(int timeSec_var);
    virtual int getTimeUsec() const;
    virtual void setTimeUsec(int timeUsec_var);
